...
export const ChoosePizzaForm: React.FC<Props> = ({
  ...
  const textDetails = `${size} см. ${mapPizzaType[type]} тесто [${selectedIngredients.size}] доп. ингредиенты`;

  const filteredPizzasBySize = items.filter((item) => item.pizzaType === type);
